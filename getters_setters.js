...
/*
    ...
    Remember that C = 5/9 * (F - 32) and F = C * 9.0 / 5 + 32, where F is the value of t
    emperature in Fahrenheit scale, and C is the value of the same temperature in Celsius scale
    ...
    This is the power of getter or setter - you are creating an API for another user, who would 
    get the correct result, no matter which one you track.
    ...
    function makeClass() {
      ...
      class Thermostat {
        constructor (fahrenheitTemp) {
          this._tempFahrenheigh = fahrenheitTemp
        }
        get temperature () {
          return 5/9*(this._tempFahrenheigh - 32)
        }
        set temperature(tempCelsius) {
          this._tempFahrenheigh = tempCelsius * 9.0 / 5 + 32;
        }
      }
   ...
   class Thermostat {
       ...
       get temperature () {
           return (this.fahrenheit - (value * 9.0) / 5.0 + 32)
       }
       }
       const thermos = new Thermostat(76); //setting in Fahrenheit scale
       let temp = thermos.temparture; // 24.44 in C
       thermos.temperature = 26;
       temp = thermos.temperature; //26 in C